...
public class Enemy : MonoBehaviour
{
    ...
    public float maxfollowdistance = 8; //max distance enemy will follow
    public float maxinterceptdistance = 19; //max distance enemy will intercept
    ...
    void Update()   
    {
        ...
        if(dist < maxfollowdistance)  //follow distance
        {
        ...
        else if(dist < maxinterceptdistance)    //intecrcept distance
        {
